...
{
    [Activity(Label = "DriverProfileActivity")]
    public class DriverProfileActivity : Activity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            Button vehBtn = FindViewById<Button>(Resource.Id.vehiclesBtn);
            vehBtn.Click += delegate
            {
                StartActivity(typeof(MyVehiclesActivity));
            };
